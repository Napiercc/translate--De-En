...
for mode in train val test; do
    subword-nmt apply-bpe -c $1/bpe.20000 -i $1/${mode}_src.cut.txt -o $1/${mode}_src.bpe
    subword-nmt apply-bpe -c $1/bpe.20000 -i $1/${mode}_trg.cut.txt -o $1/${mode}_trg.bpe
